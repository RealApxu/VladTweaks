...
PartyHasItem("helm19")
PartyHasItem("wand18")
Global("VP_XBow_Is_Done","GLOBAL",0)~ THEN GOTO IU70
END
...
IF ~~ THEN BEGIN IU718
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU719
...
IF ~~ THEN BEGIN IU719
 ...
 IF ~PartyGoldGT(34999) Global("VP_XBow_Is_Done","GLOBAL",0)~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(35000)
DestroyGold(35000) SetGlobal("VP_XBow_Is_Done","GLOBAL",1)~ GOTO 56
 IF ~PartyGoldLT(35000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU720
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU720
