...
Global("VP_Mace_Is_Done","GLOBAL",0)~ THEN GOTO IU40
END
...
IF ~~ THEN BEGIN IU47
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU48
...
IF ~~ THEN BEGIN IU48
 ...
 IF ~PartyGoldGT(9999) Global("VP_Mace_Is_Done","GLOBAL",0) PartyHasItem("rithtel")!PartyHasItem("rithore")~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(10000)
DestroyGold(10000) SetGlobal("VP_Mace_Is_Done","GLOBAL",1)~ GOTO 56
 IF ~PartyGoldGT(9999) Global("VP_Mace_Is_Done","GLOBAL",0) PartyHasItem("rithore")~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(10000)
DestroyGold(10000) SetGlobal("VP_Mace_Is_Done","GLOBAL",3)~ GOTO 56
 IF ~PartyGoldLT(10000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU49
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU49
