...
PartyHasItem("helm05")
PartyHasItem("helm19")
Global("VP_Mask_Is_Done","GLOBAL",0)~ THEN GOTO IU10
END
...
IF ~~ THEN BEGIN IU115
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU116
...
IF ~~ THEN BEGIN IU116
 ...
 IF ~Global("VP_Mask_Is_Done","GLOBAL",0) PartyGoldGT(9999)~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~SetGlobal("VP_Mask_Is_Done","GLOBAL",1) TakePartyGold(10000) DestroyGold(10000)~ GOTO 56
 IF ~PartyGoldLT(10000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU117
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU117
