...
PartyHasItem("ring35")
PartyHasItem("ring36")
Global("VP_Ring_Is_Done","GLOBAL",0)~ THEN GOTO IU300
END
...
IF ~~ THEN BEGIN IU3015
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU3016
...
IF ~~ THEN BEGIN IU3016
 ...
 IF ~PartyGoldGT(4999) Global("VP_Ring_Is_Done","GLOBAL",0)~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(5000) DestroyGold(5000) SetGlobal("VP_Ring_Is_Done","GLOBAL",1)~ GOTO 56
 IF ~PartyGoldLT(5000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU3017
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU3017
