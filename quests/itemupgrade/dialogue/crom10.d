...
PartyHasItem("leat14")
PartyHasItem("clck06")
Global("VP_Plate_Is_Done","GLOBAL",0)~ THEN GOTO IU100
END
...
IF ~~ THEN BEGIN IU1007
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU1008
...
IF ~~ THEN BEGIN IU1008
 ...
 IF ~PartyGoldGT(29999) Global("VP_Plate_Is_Done","GLOBAL",0)~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(30000) DestroyGold(30000) SetGlobal("VP_Plate_Is_Done","GLOBAL",1)~ GOTO 56
 IF ~PartyGoldLT(30000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU1009
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU1009
