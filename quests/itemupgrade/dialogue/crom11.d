...
PartyHasItem("boot01")
PartyHasItem("ring09")
Global("VP_Chain_Is_Done","GLOBAL",0)~ THEN GOTO IU200
END
...
IF ~~ THEN BEGIN IU2015
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU2016
...
IF ~~ THEN BEGIN IU2016
 ...
 IF ~PartyGoldGT(24999) Global("VP_Chain_Is_Done","GLOBAL",0)~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(25000) DestroyGold(25000) SetGlobal("VP_Chain_Is_Done","GLOBAL",1)~ GOTO 56
 IF ~PartyGoldLT(25000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU2017
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU2017
