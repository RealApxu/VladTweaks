...
Global("VP_Staff_Is_Done","GLOBAL",0)~ THEN GOTO IU50
END
...
IF ~~ THEN BEGIN IU57
 ...
 IF ~~ THEN REPLY #59740 /* ~What would be involved in that?~ */ GOTO IU58
...
IF ~~ THEN BEGIN IU58
 ...
 IF ~PartyGoldGT(9999) Global("VP_Staff_Is_Done","GLOBAL",0)~ THEN REPLY #59785 /* ~That sounds fine. Let's do it.~ */ DO ~TakePartyGold(10000)
DestroyGold(10000) SetGlobal("VP_Staff_Is_Done","GLOBAL",1)~ GOTO 56
 IF ~PartyGoldLT(10000)~ THEN REPLY ~Unfortunately, I don't have sufficient funds for that. Anything else of use?~ GOTO IU59
 IF ~~ THEN REPLY #59741 /* ~No, I'm not interested in that. Anything else of use?~ */ GOTO IU59
